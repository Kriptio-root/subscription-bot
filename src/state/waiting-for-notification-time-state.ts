...
@injectable()
export class WaitingForNotificationTimeState extends AbstractState {
  public constructor(
  @inject(SERVICE_IDENTIFIER.ILogger)
    logger: ILogger,
    @inject(SERVICE_IDENTIFIER.ReadyToSubscribeState)
    private readonly readyToSubscribeState: IState,
